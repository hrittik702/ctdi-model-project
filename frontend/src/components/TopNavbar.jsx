      ...
      <div className="flex items-center gap-2 sm:gap-2.5 shrink-0 pointer-events-auto">
        ...
        <div className="relative" ref={popoverRef}>
          <button
            ...
            className={`flex items-center gap-1.5 h-8 px-2.5 rounded-lg text-xs font-medium transition cursor-pointer border select-none shadow-sm shadow-black/5 dark:shadow-[0_2px_6px_rgba(0,0,0,0.45)] motion-press ${
              isSystemPopoverOpen
          ...
          >
            ...
            <ChevronDown className={`w-3 h-3 text-slate-400 dark:text-[#B4B4BC] transition-transform duration-fast ease-out-subtle ${
          ...
          {isSystemPopoverOpen && (
            <div className="absolute right-0 top-full mt-2 w-84 sm:w-92 bg-white dark:bg-[#111113] border border-slate-200/90 dark:border-white/[0.08] rounded-xl shadow-2xl p-4 z-50 text-xs motion-popover-enter">
