...
content = """# CTDI Paper Dataset Specifications & Benchmark Reference
...
with open("research/dataset/CTDIDataset Specifications.md", "w") as fh:
    fh.write(content)
print("Successfully generated research/dataset/CTDIDataset Specifications.md")
