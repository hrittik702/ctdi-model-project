  ...
  return (
    <div className={`relative ${className}`} ref={containerRef} onKeyDown={handleKeyDown}>
      ...
      >
        ...
        <ChevronDown className={`w-3 h-3 text-slate-400 dark:text-[#B4B4BC] shrink-0 ml-0.5 transition-transform duration-fast ease-out-subtle ${
      ...
      {isOpen && (
        <div 
          role="listbox"
          className="absolute left-0 top-full mt-2 w-76 sm:w-84 bg-white dark:bg-[#111113] border border-slate-200/90 dark:border-white/[0.08] rounded-xl shadow-2xl z-50 text-xs overflow-hidden motion-popover-enter"
        >
          {/* Header & Search */}
            ...
            <div className="flex items-center gap-1 pt-0.5">
              {[
                ...
                <button
                  ...
                  className={`flex-1 py-1 text-[11px] font-medium rounded-md transition cursor-pointer text-center motion-press ${
                    typeFilter === tab.id
